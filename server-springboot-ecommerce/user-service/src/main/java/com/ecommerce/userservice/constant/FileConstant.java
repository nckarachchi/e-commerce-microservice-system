...
public class FileConstant {
    ...
    public static final String USER_FOLDER = System.getProperty("user.home") + "/ecommerce-profile-images/user/";
    ...
    public static final String FILE_DELETE_ERROR = "Something went wrong when delete file";
}
